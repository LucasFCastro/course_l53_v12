window.billComponent = Vue.extend({
  ...
  <style media="screen">
    ...
    <ul class="dropdown-content" v-for="o in menus" :id="o.menuId">
        <li v-for="item in o.menusDropdown" class="teal">
            <a v-link="{name: item.routeName}" class="white-text">{{item.name}}</a>
        </li>
    </ul>
    ...
    <div class="navbar-fixed">
        <nav class="teal">
            <div class="nav-wrapper container">
                <a href="#" class="brand-logo right black-text">Code Contas</a>
